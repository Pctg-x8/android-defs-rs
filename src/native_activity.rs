...
pub struct ANativeActivity {
    ...
    pub env: *mut JNIEnv,
    pub class: jobject,
    pub internal_data_path: *const core::ffi::c_char,
    pub external_data_path: *const core::ffi::c_char,
    pub sdk_version: i32,
    pub instance: *mut core::ffi::c_void,
    pub asset_manager: *mut AAssetManager,
    pub obb_path: *const core::ffi::c_char,
}
...
pub struct ANativeActivityCallbacks {
    ...
    pub on_save_instance_state:
        Option<extern "C" fn(*mut ANativeActivity, *mut usize) -> *mut core::ffi::c_void>,
    ...
    pub on_window_focus_changed: Option<extern "C" fn(*mut ANativeActivity, core::ffi::c_int)>,
    ...
    pub on_native_window_redraw_needed:
        Option<extern "C" fn(*mut ANativeActivity, *mut ANativeWindow)>,
